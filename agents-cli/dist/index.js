...
// node_modules/degit/dist/index-688c5d50.js
var require_index_688c5d50 = __commonJS({
  "node_modules/degit/dist/index-688c5d50.js"(exports2) {
    "use strict";
    ...
    var highLevelOpt = (opt) => opt ? Object.keys(opt).map((k2) => [
      argmap.has(k2) ? argmap.get(k2) : k2,
      opt[k2]
    ...
    var minipass = class Minipass extends Stream__default["default"] {
      ...
      static isStream(s2) {
        return !!s2 && (s2 instanceof Minipass || s2 instanceof Stream__default["default"] || s2 instanceof Events__default["default"] && (typeof s2.pipe === "function" || // readable
        typeof s2.write === "function" && typeof s2.end === "function"));
      }
    };
    var realZlibConstants = realZlib__default["default"].constants || /* istanbul ignore next */
    { ZLIB_VERNUM: 4736 };
    ...
    var minizlib = createCommonjsModule(function(module3, exports3) {
      ...
      class Zlib extends ZlibBase {
        constructor(opts, mode) {
          opts = opts || {};
          opts.flush = opts.flush || constants$12.Z_NO_FLUSH;
          opts.finishFlush = opts.finishFlush || constants$12.Z_FINISH;
          super(opts, mode);
          this[_fullFlushFlag] = constants$12.Z_FULL_FLUSH;
        ...
        params(level, strategy) {
          ...
          if (this[_level] !== level || this[_strategy] !== strategy) {
            this.flush(constants$12.Z_SYNC_FLUSH);
            assert__default["default"](this[_handle], "zlib binding closed");
      ...
      class Brotli extends ZlibBase {
        constructor(opts, mode) {
          opts = opts || {};
          opts.flush = opts.flush || constants$12.BROTLI_OPERATION_PROCESS;
          opts.finishFlush = opts.finishFlush || constants$12.BROTLI_OPERATION_FINISH;
          super(opts, mode);
          this[_fullFlushFlag] = constants$12.BROTLI_OPERATION_FLUSH;
        }
      }
      ...
      if (typeof realZlib__default["default"].BrotliCompress === "function") {
        exports3.BrotliCompress = BrotliCompress;
        exports3.BrotliDecompress = BrotliDecompress;
      } else {
        exports3.BrotliCompress = exports3.BrotliDecompress = class {
          constructor() {
    ...
    var readEntry = class ReadEntry extends minipass {
      constructor(header2, ex, gex) {
        ...
        this.linkpath = header2.linkpath;
        this.uname = header2.uname;
        this.gname = header2.gname;
        if (ex)
          this[SLURP$1](ex);
      ...
      [SLURP$1](ex, global2) {
        for (const k2 in ex) {
          if (ex[k2] !== null && ex[k2] !== void 0 && !(global2 && k2 === "path"))
            this[k2] = ex[k2];
        }
      }
    };
    var types = createCommonjsModule(function(module3, exports3) {
      ...
      exports3.code = new Map(Array.from(exports3.name).map((kv) => [kv[1], kv[0]]));
    });
    var encode = (num, buf) => {
    ...
    var decNumber = (buf, off, size) => buf[off] & 128 ? largeNumbers.parse(buf.slice(off, off + size)) : decSmallNumber(buf, off, size);
    ...
    var encNumber = (buf, off, size, number) => number === null ? false : number > MAXNUM[size] || number < 0 ? (largeNumbers.encode(number, buf.slice(off, off + size)), true) : (encSmallNumber(buf, off, size, number), false);
    ...
    var merge = (a, b) => b ? Object.keys(a).reduce((s2, k2) => (s2[k2] = a[k2], s2), b) : a;
    ...
    var parseKVLine = (set, line) => {
      ...
      const kv = line.split("=");
      const k2 = kv.shift().replace(/^SCHILY\.(dev|ino|nlink)/, "$1");
      if (!k2)
        return set;
      const v = kv.join("=");
      set[k2] = /^([A-Z]+\.)?([mac]|birth|creation)time$/.test(k2) ? new Date(v * 1e3) : /^[0-9]+$/.test(v) ? +v : v;
      return set;
    };
    var pax = Pax;
    ...
    var WriteEntry = warnMixin(class WriteEntry extends minipass {
      ...
      [READ](fd, buf, offset, length, pos2, remain, blockRemain) {
        fs__default["default"].read(fd, buf, offset, length, pos2, (er, bytesRead) => {
          if (er) {
            return this[CLOSE](fd, () => this.emit("error", er));
          }
          this[ONREAD](fd, buf, offset, length, pos2, remain, blockRemain, bytesRead);
        });
      }
      [CLOSE](fd, cb) {
        fs__default["default"].close(fd, cb);
      }
      [ONREAD](fd, buf, offset, length, pos2, remain, blockRemain, bytesRead) {
        ...
        this[READ](fd, buf, offset, length, pos2, remain, blockRemain);
      }
    });
    var WriteEntrySync$1 = class extends WriteEntry {
      ...
      [READ](fd, buf, offset, length, pos2, remain, blockRemain) {
        let threw = true;
        try {
          const bytesRead = fs__default["default"].readSync(fd, buf, offset, length, pos2);
          this[ONREAD](fd, buf, offset, length, pos2, remain, blockRemain, bytesRead);
          threw = false;
        } finally {
          if (threw) {
    ...
    var WriteEntryTar$1 = warnMixin(class WriteEntryTar extends minipass {
      constructor(readEntry2, opt) {
        ...
        this.linkpath = readEntry2.linkpath;
        if (typeof opt.onwarn === "function")
          this.on("warn", opt.onwarn);
        let pathWarn = false;
    ...
    var Pack = warnMixin(class Pack extends minipass {
      ...
      [STAT](job) {
        ...
        fs__default["default"][stat](job.absolute, (er, stat2) => {
          job.pending = false;
          this[JOBS] -= 1;
          if (er)
            this.emit("error", er);
      ...
      [PROCESS]() {
        ...
        for (let w2 = this[QUEUE$1].head; w2 !== null && this[JOBS] < this.jobs; w2 = w2.next) {
          this[PROCESSJOB](w2.value);
          if (w2.value.ignore) {
            const p = w2.next;
            this[QUEUE$1].removeNode(w2);
            w2.next = p;
          }
        }
        this[PROCESSING] = false;
    ...
    Pack.Sync = PackSync;
    var pack = Pack;
    var EE$1 = Events__default["default"].EventEmitter;
    var writev = fs__default["default"].writev;
    if (!writev) {
    ...
    var ReadStream = class extends minipass {
      ...
      [_read]() {
        if (!this[_reading]) {
          ...
          fs__default["default"].read(this[_fd], buf, 0, buf.length, null, (er, br, buf2) => this[_onread](er, br, buf2));
        }
      }
      [_onread](er, br, buf) {
        this[_reading] = false;
    ...
    var filesFilter$1 = (opt, files) => {
      const map = new Map(files.map((f) => [f.replace(/\/+$/, ""), true]));
      const filter2 = opt.filter;
      const mapHas = (file, r) => {
        const root = r || path__default["default"].parse(file).root || ".";
        const ret = file === root ? false : map.has(file) ? map.get(file) : mapHas(path__default["default"].dirname(file), root);
        map.set(file, ret);
        return ret;
      };
      opt.filter = filter2 ? (file, entry) => filter2(file, entry) && mapHas(file.replace(/\/+$/, "")) : (file) => mapHas(file.replace(/\/+$/, ""));
    };
      ...
      try {
        ...
        if (stat.size < readSize)
          ...
          while (pos2 < stat.size) {
            const bytesRead = fs__default["default"].readSync(fd, buf, 0, readSize, pos2);
            pos2 += bytesRead;
      ...
      while (files.length) {
        ...
        if (file.charAt(0) === "@") {
          return list_1({
            ...
            noResume: true,
            onentry: (entry) => p.add(entry)
          }).then((_2) => addFilesAsync$1(p, files));
        } else
          p.add(file);
      }
      p.end();
    ...
    var replaceSync = (opt, files) => {
      ...
      try {
        ...
        const st3 = fs__default["default"].fstatSync(fd);
        const headBuf = Buffer.alloc(512);
        POSITION: for (position = 0; position < st3.size; position += 512) {
          ...
          if (position + entryBlockSize + 512 > st3.size)
            break;
    ...
    var replace = (opt, files, cb) => {
      ...
      const promise = new Promise((resolve2, reject) => {
        ...
        const onopen = (er, fd) => {
          ...
          if (er)
            return reject(er);
          fs__default["default"].fstat(fd, (er2, st3) => {
            if (er2)
              return reject(er2);
            getPos(fd, st3.size, (er3, position) => {
              if (er3)
                return reject(er3);
              const stream = new fsMinipass.WriteStream(opt.file, {
                fd,
    ...
    var optsArg = (opts) => {
      if (!opts)
        opts = { mode: 511, fs: fs__default["default"] };
      else if (typeof opts === "object")
        opts = { mode: 511, fs: fs__default["default"], ...opts };
    ...
    var { resolve, parse: parse$3 } = path__default["default"];
    var pathArg = (path2) => {
      if (/\0/.test(path2)) {
        throw Object.assign(
    ...
    var findMade$1 = (opts, parent, path2 = void 0) => {
      if (path2 === parent)
        return Promise.resolve();
      return opts.statAsync(parent).then(
        (st3) => st3.isDirectory() ? path2 : void 0,
        // will fail later
        (er) => er.code === "ENOENT" ? findMade$1(opts, dirname$2(parent), parent) : void 0
      );
    };
    var findMadeSync$1 = (opts, parent, path2 = void 0) => {
      if (path2 === parent)
        return void 0;
      try {
    ...
    var mkdirpManual$2 = (path2, opts, made) => {
      ...
      return opts.mkdirAsync(path2, opts).then(() => made || path2, (er) => {
        ...
        if (er.code !== "EEXIST" && er.code !== "EROFS")
          throw er;
        return opts.statAsync(path2).then((st3) => {
          if (st3.isDirectory())
            return made;
          else
            throw er;
    ...
    var mkdirpManualSync$2 = (path2, opts, made) => {
      const parent = dirname$1(path2);
      opts.recursive = false;
      if (parent === path2) {
        try {
    ...
    var mkdirpNativeSync$1 = (path2, opts) => {
      opts.recursive = true;
      const parent = dirname3(path2);
      if (parent === path2)
        return opts.mkdirSync(path2, opts);
    ...
    var version$1 = process.env.__TESTING_MKDIRP_NODE_VERSION__ || process.version;
    var versArr = version$1.replace(/^v/, "").split(".");
    var hasNative = +versArr[0] > 10 || +versArr[0] === 10 && +versArr[1] >= 12;
    var useNative$1 = !hasNative ? () => false : (opts) => opts.mkdir === fs__default["default"].mkdir;
    var useNativeSync$1 = !hasNative ? () => false : (opts) => opts.mkdirSync === fs__default["default"].mkdirSync;
    ...
    var mkdirp$3 = (path2, opts) => {
      path2 = pathArg_1(path2);
      opts = optsArg_1(opts);
    ...
    mkdirp$3.native = (path2, opts) => mkdirpNative(pathArg_1(path2), optsArg_1(opts));
    mkdirp$3.manual = (path2, opts) => mkdirpManual(pathArg_1(path2), optsArg_1(opts));
    mkdirp$3.nativeSync = (path2, opts) => mkdirpNativeSync(pathArg_1(path2), optsArg_1(opts));
    mkdirp$3.manualSync = (path2, opts) => mkdirpManualSync(pathArg_1(path2), optsArg_1(opts));
    ...
    var lchownSync = (path2, uid, gid) => {
      try {
        return fs__default["default"][LCHOWNSYNC](path2, uid, gid);
      } catch (er) {
        if (er.code !== "ENOENT")
          throw er;
      }
    ...
    var chownSync = (path2, uid, gid) => {
      try {
        return fs__default["default"].chownSync(path2, uid, gid);
      } catch (er) {
        if (er.code !== "ENOENT")
          throw er;
      }
    ...
    var handleEISDIR = needEISDIRHandled ? (path2, uid, gid, cb) => (er) => {
      if (!er || er.code !== "EISDIR")
        ...
        fs__default["default"].chown(path2, uid, gid, cb);
    } : (_2, __, ___, cb) => cb;
    ...
    var readdir = (path2, options2, cb) => fs__default["default"].readdir(path2, options2, cb);
    var readdirSync4 = (path2, options2) => fs__default["default"].readdirSync(path2, options2);
    if (/^v4\./.test(nodeVersion))
      readdir = (path2, options2, cb) => fs__default["default"].readdir(path2, cb);
    ...
    var mkdir = (dir, opt, cb) => {
      ...
      const done = (er, created) => {
        if (er)
          ...
          cache.set(dir, true);
          if (created && doChown)
            chownr_1(created, uid, gid, (er2) => done(er2));
          else if (needChmod)
      ...
      if (cache && cache.get(dir) === true)
        return done();
      if (dir === cwd2) {
        return fs__default["default"].stat(dir, (er, st3) => {
          if (er || !st3.isDirectory())
      ...
      const sub = path__default["default"].relative(cwd2, dir);
      const parts = sub.split(/\/|\\/);
      mkdir_(cwd2, parts, mode, cache, unlink, cwd2, null, done);
    };
    var mkdir_ = (base2, parts, mode, cache, unlink, cwd2, created, cb) => {
      if (!parts.length)
      ...
      fs__default["default"].mkdir(part, mode, onmkdir(part, parts, mode, cache, unlink, cwd2, created, cb));
    };
    var onmkdir = (part, parts, mode, cache, unlink, cwd2, created, cb) => (er) => {
      if (er) {
        if (er.path && path__default["default"].dirname(er.path) === cwd2 && (er.code === "ENOTDIR" || er.code === "ENOENT"))
          return cb(new CwdError(cwd2, er.code));
        fs__default["default"].lstat(part, (statEr, st3) => {
          if (statEr)
            cb(statEr);
          else if (st3.isDirectory())
            mkdir_(part, parts, mode, cache, unlink, cwd2, created, cb);
          else if (unlink) {
            fs__default["default"].unlink(part, (er2) => {
              if (er2)
                return cb(er2);
              fs__default["default"].mkdir(part, mode, onmkdir(part, parts, mode, cache, unlink, cwd2, created, cb));
            });
          } else if (st3.isSymbolicLink())
    ...
    var sync$1 = (dir, opt) => {
      ...
      const done = (created2) => {
        cache.set(dir, true);
        if (created2 && doChown)
          chownr_1.sync(created2, uid, gid);
        if (needChmod)
      ...
      if (dir === cwd2) {
        ...
        let code = "ENOTDIR";
        try {
          ok2 = fs__default["default"].statSync(dir).isDirectory();
        } catch (er) {
          code = er.code;
        } finally {
          if (!ok2)
      ...
      for (let p = parts.shift(), part = cwd2; p && (part += "/" + p); p = parts.shift()) {
        ...
        try {
          ...
          if (er.path && path__default["default"].dirname(er.path) === cwd2 && (er.code === "ENOTDIR" || er.code === "ENOENT"))
            return new CwdError(cwd2, er.code);
          const st3 = fs__default["default"].lstatSync(part);
          if (st3.isDirectory()) {
            cache.set(part, true);
            continue;
          } else if (unlink) {
    ...
    var pathReservations = () => {
      ...
      const check = (fn) => {
        ...
        return paths.every((q3) => q3[0] === fn) && dirs.every((q3) => q3[0] instanceof Set && q3[0].has(fn));
      };
      const run = (fn) => {
      ...
      const clear = (fn) => {
        ...
        paths.forEach((path2) => {
          const q3 = queues.get(path2);
          assert__default["default"].equal(q3[0], fn);
          if (q3.length === 1)
            queues.delete(path2);
          else {
            q3.shift();
            if (typeof q3[0] === "function")
              next.add(q3[0]);
            else
              q3[0].forEach((fn2) => next.add(fn2));
          }
        });
        dirs.forEach((dir) => {
          const q3 = queues.get(dir);
          assert__default["default"](q3[0] instanceof Set);
          if (q3[0].size === 1 && q3.length === 1)
            queues.delete(dir);
          else if (q3[0].size === 1) {
            q3.shift();
            next.add(q3[0]);
      ...
      const reserve = (paths, fn) => {
        ...
        dirs.forEach((dir) => {
          ...
          else if (q3[q3.length - 1] instanceof Set)
            q3[q3.length - 1].add(fn);
          else
            q3.push(/* @__PURE__ */ new Set([fn]));
        });
        return run(fn);
      };
    ...
    var fs = commonjsGlobal.__FAKE_TESTING_FS__ || fs__default["default"];
    ...
    var unlinkFile = (path2, cb) => {
      if (process.platform !== "win32")
        return fs__default["default"].unlink(path2, cb);
      const name = path2 + ".DELETE." + crypto__default["default"].randomBytes(16).toString("hex");
      fs__default["default"].rename(path2, name, (er) => {
        if (er)
          return cb(er);
    ...
    var unlinkFileSync = (path2) => {
      if (process.platform !== "win32")
        return fs__default["default"].unlinkSync(path2);
      const name = path2 + ".DELETE." + crypto__default["default"].randomBytes(16).toString("hex");
      fs__default["default"].renameSync(path2, name);
    ...
    var Unpack = class extends parse$4 {
      ...
      [FILE](entry, fullyDone) {
        ...
        const done = (er) => {
          ...
          if (--actions === 0) {
            fs__default["default"].close(stream.fd, (er2) => {
              fullyDone();
      ...
      [ISREUSABLE](entry, st3) {
        return entry.type === "File" && !this.unlink && st3.isFile() && st3.nlink <= 1 && process.platform !== "win32";
      }
      ...
      [CHECKFS2](entry, done) {
        this[MKDIR](path__default["default"].dirname(entry.absolute), this.dmode, (er) => {
          ...
          fs__default["default"].lstat(entry.absolute, (er2, st3) => {
            if (st3 && (this.keep || this.newer && st3.mtime > entry.mtime)) {
              this[SKIP](entry);
              done();
            } else if (er2 || this[ISREUSABLE](entry, st3))
              this[MAKEFS](null, entry, done);
            else if (st3.isDirectory()) {
              if (entry.type === "Directory") {
                if (!this.noChmod && (!entry.mode || (st3.mode & 4095) === entry.mode))
                  this[MAKEFS](null, entry, done);
                else {
                  fs__default["default"].chmod(
                    entry.absolute,
                    entry.mode,
                    (er3) => this[MAKEFS](er3, entry, done)
                  );
                }
              } else
                fs__default["default"].rmdir(entry.absolute, (er3) => this[MAKEFS](er3, entry, done));
            } else
      ...
      [LINK](entry, linkpath, link2, done) {
        fs__default["default"][link2](linkpath, entry.absolute, (er) => {
          if (er)
            return this[ONERROR](er, entry);
          done();
          this[UNPEND]();
    ...
    var UnpackSync = class extends Unpack {
      [CHECKFS](entry) {
        ...
        if (er)
          return this[ONERROR](er, entry);
        try {
          const st3 = fs__default["default"].lstatSync(entry.absolute);
          if (this.keep || this.newer && st3.mtime > entry.mtime)
            return this[SKIP](entry);
          else if (this[ISREUSABLE](entry, st3))
    ...
    var tar = createCommonjsModule(function(module3, exports3) {
      exports3.c = exports3.create = create_1;
      exports3.r = exports3.replace = replace_1;
      exports3.t = exports3.list = list_1;
      exports3.u = exports3.update = update;
      exports3.x = exports3.extract = extract_1;
      exports3.Pack = pack;
      exports3.Unpack = unpack;
      exports3.Parse = parse$4;
      exports3.ReadEntry = readEntry;
    ...
    convert$1.rgb.cmyk = function(rgb) {
      ...
      const y3 = (1 - b - k2) / (1 - k2) || 0;
      return [c * 100, m2 * 100, y3 * 100, k2 * 100];
    };
    ...
    convert$1.cmyk.rgb = function(cmyk) {
      ...
      const b = 1 - Math.min(1, y3 * (1 - k2) + k2);
      return [r * 255, g * 255, b * 255];
    };
    convert$1.xyz.rgb = function(xyz) {
      ...
      let g;
      let b;
      r = x3 * 3.2406 + y3 * -1.5372 + z2 * -0.4986;
      g = x3 * -0.9689 + y3 * 1.8758 + z2 * 0.0415;
      b = x3 * 0.0557 + y3 * -0.204 + z2 * 1.057;
      ...
      const makeDynamicStyles = (wrap2, targetSpace, identity, isBackground) => {
        ...
        for (const [sourceSpace, suite] of Object.entries(colorConvert$1)) {
          ...
          if (sourceSpace === targetSpace) {
            styles4[name] = wrap2(identity, offset);
          ...
          return function(from, to, cb) {
            ...
            fs$rename(from, to, function CB(er) {
              if (er && (er.code === "EACCES" || er.code === "EPERM") && Date.now() - start < 6e4) {
                setTimeout(function() {
                  fs2.stat(to, function(stater, st3) {
    ...
    function patchLchmod(fs2) {
      ...
      fs2.lchmodSync = function(path2, mode) {
        var fd = fs2.openSync(path2, constants__default["default"].O_WRONLY | constants__default["default"].O_SYMLINK, mode);
        var threw = true;
        var ret;
        try {
    ...
    function patchLutimes(fs2) {
      if (constants__default["default"].hasOwnProperty("O_SYMLINK")) {
        fs2.lutimes = function(path2, at3, mt3, cb) {
          fs2.open(path2, constants__default["default"].O_SYMLINK, function(er, fd) {
            if (er) {
              if (cb) cb(er);
              return;
            }
            fs2.futimes(fd, at3, mt3, function(er2) {
        ...
        fs2.lutimesSync = function(path2, at3, mt3) {
          var fd = fs2.openSync(path2, constants__default["default"].O_SYMLINK);
          var ret;
          var threw = true;
          try {
            ret = fs2.futimesSync(fd, at3, mt3);
            threw = false;
          } finally {
            if (threw) {
              try {
    ...
    function legacy(fs2) {
      ...
      function ReadStream2(path2, options2) {
        if (!(this instanceof ReadStream2)) return new ReadStream2(path2, options2);
        Stream.call(this);
        var self2 = this;
        this.path = path2;
        this.fd = null;
      ...
      function WriteStream2(path2, options2) {
        if (!(this instanceof WriteStream2)) return new WriteStream2(path2, options2);
        Stream.call(this);
        this.path = path2;
        this.fd = null;
        this.writable = true;
    ...
    var gracefulFs = createCommonjsModule(function(module3) {
      var queue = [];
      function noop2() {
      }
      var debug2 = noop2;
      if (util__default["default"].debuglog)
        debug2 = util__default["default"].debuglog("gfs4");
      else if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || ""))
        debug2 = function() {
          var m2 = util__default["default"].format.apply(util__default["default"], arguments);
          m2 = "GFS4: " + m2.split(/\n/).join("\nGFS4: ");
          console.error(m2);
        };
      ...
      function patch2(fs2) {
        ...
        fs2.FileReadStream = ReadStream2;
        fs2.FileWriteStream = WriteStream2;
        ...
        function readFile(path2, options2, cb) {
          ...
          function go$readFile(path3, options3, cb2) {
            return fs$readFile(path3, options3, function(err) {
              if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
                enqueue([go$readFile, [path3, options3, cb2]]);
              else {
        ...
        function writeFile(path2, data, options2, cb) {
          ...
          function go$writeFile(path3, data2, options3, cb2) {
            return fs$writeFile(path3, data2, options3, function(err) {
              if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
                enqueue([go$writeFile, [path3, data2, options3, cb2]]);
              else {
                if (typeof cb2 === "function")
                  cb2.apply(this, arguments);
                retry();
        ...
        function appendFile(path2, data, options2, cb) {
          ...
          function go$appendFile(path3, data2, options3, cb2) {
            return fs$appendFile(path3, data2, options3, function(err) {
              if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
                enqueue([go$appendFile, [path3, data2, options3, cb2]]);
              else {
                if (typeof cb2 === "function")
                  cb2.apply(this, arguments);
                retry();
        ...
        if (process.version.substr(0, 4) === "v0.8") {
          var legStreams = legacyStreams(fs2);
        ...
        fs2.ReadStream = ReadStream2;
        fs2.WriteStream = WriteStream2;
        function ReadStream2(path2, options2) {
        ...
        function createReadStream(path2, options2) {
          return new ReadStream2(path2, options2);
        }
        function createWriteStream(path2, options2) {
          return new WriteStream2(path2, options2);
        }
    ...
    function mkdirP(p, opts, f, made) {
      ...
      xfs.mkdir(p, mode, function(er) {
        ...
        switch (er.code) {
          case "ENOENT":
            mkdirP(path__default["default"].dirname(p), opts, function(er2, made2) {
              if (er2) cb(er2, made2);
    ...
    mkdirP.sync = function sync2(p, opts, made) {
      ...
      try {
        ...
        switch (err0.code) {
          case "ENOENT":
            made = sync2(path__default["default"].dirname(p), opts, made);
            sync2(p, opts, made);
            break;
          // In the case of any other error, just see if there's a dir
          // there already.  If so, then hooray!  If not, then something
    ...
    var splitRootRe;
    var realpathSync$1 = function realpathSync2(p, cache) {
      p = path__default["default"].resolve(p);
      ...
      function start() {
        ...
        base2 = m2[0];
        previous = "";
        if (isWindows$1 && !knownHard[base2]) {
          fs__default["default"].lstatSync(base2);
      ...
      while (pos2 < p.length) {
        ...
        if (cache && Object.prototype.hasOwnProperty.call(cache, base2)) {
          ...
          var stat = fs__default["default"].lstatSync(base2);
          if (!stat.isSymbolicLink()) {
            knownHard[base2] = true;
            if (cache) cache[base2] = base2;
            continue;
          }
          var linkTarget = null;
          if (!isWindows$1) {
          ...
          if (linkTarget === null) {
            fs__default["default"].statSync(base2);
            linkTarget = fs__default["default"].readlinkSync(base2);
          }
        ...
        p = path__default["default"].resolve(resolvedLink, p.slice(pos2));
        start();
      }
      if (cache) cache[original] = p;
      return p;
    };
    var realpath$1 = function realpath2(p, cache, cb) {
      if (typeof cb !== "function") {
      ...
      function start() {
        ...
        previous = "";
        if (isWindows$1 && !knownHard[base2]) {
          fs__default["default"].lstat(base2, function(err) {
      ...
      function LOOP() {
        ...
        return fs__default["default"].lstat(base2, gotStat);
      }
      function gotStat(err, stat) {
        ...
        fs__default["default"].stat(base2, function(err2) {
          if (err2) return cb(err2);
          fs__default["default"].readlink(base2, function(err3, target) {
      ...
      function gotTarget(err, target, base3) {
        ...
        if (cache) cache[base3] = resolvedLink;
    ...
    function minimatch(p, pattern, options2) {
      ...
      return new Minimatch$1(pattern, options2).match(p);
    }
    function Minimatch$1(pattern, options2) {
      if (!(this instanceof Minimatch$1)) {
        return new Minimatch$1(pattern, options2);
      }
      if (typeof pattern !== "string") {
        throw new TypeError("glob pattern string required");
      }
    ...
    function make() {
      ...
      if (options2.debug) this.debug = console.error;
    ...
    function parse$2(pattern, isSub) {
      ...
      var options2 = this.options;
      if (!options2.noglobstar && pattern === "**") return GLOBSTAR;
      if (pattern === "") return "";
      var re = "";
    ...
    minimatch.makeRe = function(pattern, options2) {
      return new Minimatch$1(pattern, options2 || {}).makeRe();
    };
    ...
    minimatch.match = function(list2, pattern, options2) {
      options2 = options2 || {};
      var mm = new Minimatch$1(pattern, options2);
    ...
    function setopts$2(self2, pattern, options2) {
      if (!options2)
        options2 = {};
      ...
      if (!ownProp$2(options2, "cwd"))
        ...
        self2.cwd = path__default["default"].resolve(options2.cwd);
        self2.changedCwd = self2.cwd !== cwd2;
      }
      self2.root = options2.root || path__default["default"].resolve(self2.cwd, "/");
      self2.root = path__default["default"].resolve(self2.root);
      if (process.platform === "win32")
        self2.root = self2.root.replace(/\\/g, "/");
      self2.cwdAbs = pathIsAbsolute(self2.cwd) ? self2.cwd : makeAbs(self2, self2.cwd);
      if (process.platform === "win32")
    ...
    function makeAbs(self2, f) {
      var abs = f;
      if (f.charAt(0) === "/") {
        abs = path__default["default"].join(self2.root, f);
      } else if (pathIsAbsolute(f) || f === "") {
        abs = f;
      } else if (self2.changedCwd) {
        abs = path__default["default"].resolve(self2.cwd, f);
      } else {
    ...
    function globSync(pattern, options2) {
      ...
      return new GlobSync$1(pattern, options2).found;
    }
    function GlobSync$1(pattern, options2) {
      if (!pattern)
        throw new Error("must provide pattern");
      if (typeof options2 === "function" || arguments.length === 3)
        throw new TypeError("callback provided to sync glob\nSee: https://github.com/isaacs/node-glob/issues/167");
      if (!(this instanceof GlobSync$1))
        return new GlobSync$1(pattern, options2);
      setopts$1(this, pattern, options2);
      if (this.noprocess)
        return this;
      ...
      if (this.realpath) {
        ...
        this.matches.forEach(function(matchset, index) {
          ...
          for (var p in matchset) {
            try {
              p = self2._makeAbs(p);
              var real = fs_realpath.realpathSync(p, self2.realpathCache);
              set[real] = true;
            } catch (er) {
              if (er.syscall === "stat")
      ...
      if (remain.length === 1 && !this.mark && !this.stat) {
        ...
        for (var i = 0; i < len; i++) {
          ...
          if (e2.charAt(0) === "/" && !this.nomount) {
            e2 = path__default["default"].join(this.root, e2);
          }
    ...
    GlobSync$1.prototype._emitMatch = function(index, e2) {
    ...
    function glob$1(pattern, options2, cb) {
      if (typeof options2 === "function") cb = options2, options2 = {};
      if (!options2) options2 = {};
      if (options2.sync) {
        if (cb)
          throw new TypeError("callback provided to sync glob");
        return sync(pattern, options2);
      }
    ...
    Glob.prototype._realpathSet = function(index, cb) {
      ...
      found.forEach(function(p, i) {
        p = self2._makeAbs(p);
        fs_realpath.realpath(p, self2.realpathCache, function(er, real) {
          if (!er)
            set[real] = true;
    ...
    Glob.prototype._emitMatch = function(index, e2) {
      ...
      var abs = pathIsAbsolute(e2) ? e2 : this._makeAbs(e2);
      if (this.mark)
        e2 = this._mark(e2);
      if (this.absolute)
        e2 = abs;
      ...
      this.matches[index][e2] = true;
      var st3 = this.statCache[abs];
      if (st3)
        this.emit("stat", e2, st3);
      this.emit("match", e2);
    };
    ...
    Glob.prototype._stat = function(f, cb) {
      ...
      function lstatcb_(er, lstat) {
        if (lstat && lstat.isSymbolicLink()) {
          return fs__default["default"].stat(abs, function(er2, stat2) {
            if (er2)
    ...
    function defaults(options2) {
      ...
      methods.forEach(function(m2) {
        options2[m2] = options2[m2] || fs__default["default"][m2];
        m2 = m2 + "Sync";
        options2[m2] = options2[m2] || fs__default["default"][m2];
      });
    ...
    function rimraf(p, options2, cb) {
      ...
      assert__default["default"](options2, "rimraf: invalid options argument provided");
      assert__default["default"].equal(typeof options2, "object", "rimraf: options should be object");
      defaults(options2);
      var busyTries = 0;
      var errState = null;
      var n = 0;
      ...
      options2.lstat(p, function(er, stat) {
        if (!er)
          return afterGlob(null, [p]);
      ...
      function afterGlob(er, results) {
        ...
        results.forEach(function(p2) {
          rimraf_(p2, options2, function CB(er2) {
            if (er2) {
    ...
    function rimraf_(p, options2, cb) {
      ...
      assert__default["default"](options2);
      assert__default["default"](typeof cb === "function");
      options2.lstat(p, function(er, st3) {
        if (er && er.code === "ENOENT")
          return cb(null);
        ...
        options2.unlink(p, function(er2) {
          if (er2) {
            if (er2.code === "ENOENT")
              return cb(null);
            if (er2.code === "EPERM")
    ...
    function fixWinEPERM(p, options2, er, cb) {
      ...
      options2.chmod(p, _0666, function(er2) {
        if (er2)
          cb(er2.code === "ENOENT" ? null : er);
        else
          options2.stat(p, function(er3, stats) {
            if (er3)
    ...
    function rmkids(p, options2, cb) {
      ...
      assert__default["default"](options2);
      assert__default["default"](typeof cb === "function");
      options2.readdir(p, function(er, files) {
        if (er)
          return cb(er);
        var n = files.length;
        if (n === 0)
        ...
        files.forEach(function(f) {
          rimraf(path__default["default"].join(p, f), options2, function(er2) {
            if (errState)
              return;
            if (er2)
              return cb(errState = er2);
    ...
    function rimrafSync$1(p, options2) {
      options2 = options2 || {};
      defaults(options2);
      assert__default["default"](p, "rimraf: missing path");
      assert__default["default"].equal(typeof p, "string", "rimraf: path should be a string");
      assert__default["default"](options2, "rimraf: missing options");
      assert__default["default"].equal(typeof options2, "object", "rimraf: options should be object");
      var results;
      if (options2.disableGlob || !glob.hasMagic(p)) {
        results = [p];
    ...
    function rmkidsSync(p, options2) {
      assert__default["default"](p);
      assert__default["default"](options2);
      options2.readdirSync(p).forEach(function(f) {
        rimrafSync$1(path__default["default"].join(p, f), options2);
      });
      ...
      do {
        var threw = true;
        try {
          var ret = options2.rmdirSync(p, options2);
          threw = false;
          return ret;
        } finally {
          if (++i < retries && threw)
    ...
    function resolvePathAndOptions(args) {
      ...
      return { options: options2, resolvedPath };
    }
    function copydirSync() {
      var ref = resolvePathAndOptions(arguments);
      var src2 = ref.resolvedPath;
      ...
      return {
        to: function to() {
          ...
          function copydir(src3, dest2) {
            mkdirp$1.sync(dest2);
            gracefulFs.readdirSync(src3).forEach(function(filename) {
              var srcpath = src3 + path__default["default"].sep + filename;
              var destpath = dest2 + path__default["default"].sep + filename;
    ...
    var node = createCommonjsModule(function(module3, exports3) {
      exports3.init = init;
      exports3.log = log;
      exports3.formatArgs = formatArgs;
      exports3.save = save;
      ...
      function useColors() {
        return "colors" in exports3.inspectOpts ? Boolean(exports3.inspectOpts.colors) : tty__default["default"].isatty(process.stderr.fd);
      }
      function formatArgs(args) {
      ...
      function init(debug2) {
        ...
        for (let i = 0; i < keys.length; i++) {
          debug2.inspectOpts[keys[i]] = exports3.inspectOpts[keys[i]];
        }
      }
      module3.exports = common(exports3);
      const { formatters } = module3.exports;
    ...
    var src$1 = createCommonjsModule(function(module3) {
    ...
    var debug_1$2 = __importDefault$3(src$1);
    var promisify_1 = __importDefault$3(promisify_1$1);
    ...
    var net_1 = __importDefault$1(require$$0__default$2["default"]);
    var tls_1 = __importDefault$1(require$$1__default["default"]);
    var url_1 = __importDefault$1(require$$2__default["default"]);
    var assert_1 = __importDefault$1(assert__default["default"]);
    var debug_1 = __importDefault$1(src$1);
    var parse_proxy_response_1 = __importDefault$1(parseProxyResponse_1);
...
`);
    ...
    var tmpDirName = "tmp";
    var degitConfigName = "degit.json";
    ...
    function fetch(url, dest, proxy) {
      return new Promise((fulfil, reject) => {
        ...
        https__default["default"].get(options2, (response) => {
      ...
      constructor(src2, opts = {}) {
        ...
        this.directiveActions = {
          clone: async (dir, dest, action) => {
            ...
            const d3 = degit2(action.src, opts2);
            d3.on("info", (event) => {
              console.error(
      ...
      async clone(dest) {
        ...
        if (directives) {
          for (const d3 of directives) {
            await this.directiveActions[d3.action](dir, dest, d3);
          }
        ...
        if (removedFiles.length > 0) {
          this._info({
            ...
            message: `removed: ${source.bold(
              removedFiles.map((d3) => source.bold(d3)).join(", ")
            )}`
          });
        }
      }
    ...
    function parse2(src2) {
      ...
      if (!match2) {
        throw new DegitError(`could not parse ${src2}`, {
          code: "BAD_SRC"
        });
      }
      const site = (match2[1] || match2[2] || match2[3] || "github").replace(
        /\.(com|org)$/,
        ""
      );
      ...
      const user = match2[4];
      const name = match2[5].replace(/\.git$/, "");
      const subdir = match2[6];
      const ref = match2[7] || "HEAD";
    ...
    async function fetchRefs(repo) {
      try {
        ...
        return stdout.split("\n").filter(Boolean).map((row) => {
          ...
          const match2 = /refs\/(\w+)\/(.+)/.exec(ref);
          if (!match2)
            throw new DegitError(`could not parse ${ref}`, {
              code: "BAD_REF"
            });
          return {
            type: match2[1] === "heads" ? "branch" : match2[1] === "refs" ? "ref" : match2[1],
            name: match2[2],
            hash
          };
        });
...
// node_modules/degit/dist/index.js
var require_dist = __commonJS({
  "node_modules/degit/dist/index.js"(exports2, module2) {
    "use strict";
    __require("fs");
    __require("path");
...
var require_conversions = __commonJS({
  "node_modules/color-convert/conversions.js"(exports2, module2) {
    ...
    convert.xyz.rgb = function(xyz) {
      ...
      let g;
      let b;
      r = x3 * 3.2406 + y2 * -1.5372 + z2 * -0.4986;
      g = x3 * -0.9689 + y2 * 1.8758 + z2 * 0.0415;
      b = x3 * 0.0557 + y2 * -0.204 + z2 * 1.057;
      r = r > 31308e-7 ? 1.055 * r ** (1 / 2.4) - 0.055 : r * 12.92;
      g = g > 31308e-7 ? 1.055 * g ** (1 / 2.4) - 0.055 : g * 12.92;
      b = b > 31308e-7 ? 1.055 * b ** (1 / 2.4) - 0.055 : b * 12.92;
      r = Math.min(Math.max(0, r), 1);
...
var require_wcwidth = __commonJS({
  "node_modules/wcwidth/index.js"(exports2, module2) {
    ...
    module2.exports = function wcwidth2(str2) {
    ...
    function wcswidth(str2, opts) {
      if (typeof str2 !== "string") return wcwidth(str2, opts);
      var s = 0;
...
function getPlatformPaths(platform, global2) {
  const home = homedir();
  const paths = {
    "opencode": {
  ...
  return global2 ? paths[platform].global : paths[platform].project;
}
...
var logger = {
  ...
  error: (msg) => console.error(source_default.red("\u2717"), msg),
  debug: (msg) => {
    if (process.env.DEBUG === "npx-agents") {
      console.log(source_default.gray("[debug]"), msg);
    }
  }
};
    ...
    for (const platform of platforms) {
      ...
      for (const targetPath of targetPaths) {
        ...
        for (const agentFile of agents) {
          ...
          if (existsSync3(finalPath) && !options2.yes) {
...
function listInstalledAgents(platform, global2) {
  const agents = [];
  const paths = getPlatformPaths(platform, global2);
...
function removeAgent(name, platform, global2) {
  const paths = getPlatformPaths(platform, global2);
  for (const path of paths) {
...
var S_CHECKBOX_ACTIVE = import_picocolors2.default.green("\u2611");
var S_CHECKBOX_INACTIVE = import_picocolors2.default.dim("\u2610");
var S_CHECKBOX_LOCKED = import_picocolors2.default.green("\u2713");
var S_BULLET = import_picocolors2.default.blue("\u25CF");
var S_BAR = import_picocolors2.default.dim("\u2502");
var S_BAR_H = import_picocolors2.default.dim("\u2500");
var S_CORNER_TOP = import_picocolors2.default.dim("\u250C");
var S_CORNER_BOTTOM = import_picocolors2.default.dim("\u2514");
var S_BRANCH = import_picocolors2.default.dim("\u251C");
var S_BRANCH_END = import_picocolors2.default.dim("\u2514");
var LOGO_LINES = [
  " \u2588\u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2588\u2557   \u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557",
  "\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D \u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D\u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2551\u255A\u2550\u2550\u2588\u2588\u2554\u2550\u2550\u255D\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D",
  "\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2551  \u2588\u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2554\u2588\u2588\u2557 \u2588\u2588\u2551   \u2588\u2588\u2551   \u2588\u2588\u2588\u2588\u2588\u2557  ",
...
function showBanner() {
  showLogo();
  console.log(import_picocolors2.default.dim("  AI Agent Management CLI"));
  console.log();
  console.log(`  ${import_picocolors2.default.dim("$")} ${import_picocolors2.default.cyan("npx opencode-agents add")} ${import_picocolors2.default.dim("<repo>")}     ${import_picocolors2.default.dim("Install agents from a repository")}`);
  console.log(`  ${import_picocolors2.default.dim("$")} ${import_picocolors2.default.cyan("npx opencode-agents list")}              ${import_picocolors2.default.dim("List installed agents")}`);
  console.log(`  ${import_picocolors2.default.dim("$")} ${import_picocolors2.default.cyan("npx opencode-agents remove")}            ${import_picocolors2.default.dim("Remove installed agents")}`);
...
async function removeCommand(name, options2) {
  const spinner = (0, import_ora.default)(`Removing agent "${name}"...`).start();
  try {
    let platforms;
    if (options2.agent) {
      platforms = [options2.agent];
    ...
    let removed = false;
    for (const platform of platforms) {
      const result = removeAgent(name, platform, options2.global);
      if (result) {
        removed = true;
      }
    }
...
async function findCommand(query, _options) {
  ...
  console.log(source_default.dim("Alternatively, you can:"));
  console.log(source_default.dim("  1. Check GitHub for agent repositories"));
  console.log(source_default.dim('  2. Use "npx agents add <owner/repo>" to install directly'));
}
...
async function checkCommand() {
  ...
  console.log(source_default.dim("Add version info to your agents to enable update checking."));
}
...
async function updateCommand() {
  ...
  console.log(source_default.dim("To update an agent, remove it and reinstall:"));
  console.log(source_default.dim("  npx agents remove <agent-name>"));
  console.log(source_default.dim("  npx agents add <source>"));
}

// src/index.ts
var program2 = new Command();
program2.name("agents").description("CLI for managing AI coding agents").version("1.1.0");
...
program2.command("check").description("Check for updates to installed agents").action(checkCommand);
program2.command("update").description("Update all installed agents to the latest version").action(updateCommand);
