...
const fire_utils_1 = require("./fire-utils");
function createPrefab(name) {
    const fileId = (0, fire_utils_1.generateFileId)();
    return [
        {
            __type__: "cc.Prefab",
            _name: "",
...
function createScene(sceneName) {
    const sceneUUID = (0, utils_1.generateUUID)();
    const canvasUUID = (0, utils_1.generateUUID)();
    const cameraUUID = (0, utils_1.generateUUID)();
    return [
        {
